...
const Container: React.FC<ContainerProps> = ({ title, description, topics }) => {
  ...
  return (
    <div
      className={`bg-white p-5 rounded shadow-xl h-40  ring-1 ring-slate-900/5 mb-4 ${
    ...
    >
      ...
      <ul className="text-gray-100 flex mt-3 pr-3 font-thin ">
